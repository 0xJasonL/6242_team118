# Flight Delay Dashboard - Combined
...
```text
6242-data-visualization/
|- datamodel/                   Data preparation, model training, saved model
|- combined-dashboard/
...
The data preparation step lives in [datamodel/data.py](C:/Users/Admin/Documents/GitHub/6242-data-visualization/datamodel/data.py).
